...
export const AltmetricsChart: React.FC<AltmetricsChartProps> = ({ doi }) => {
    ...
    useEffect(() => {
        ...
        const citedByChart =
            new Chart(citedByCanvas as ChartItem, {
                type: "bar",
                data: {
                    labels: [
                        "Tweeters",
            ...
            {show &&
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="chart-container">
                        <h3 className="text-lg font-medium mb-2">Cohorts Breakdown</h3>
                        <canvas id="cohortsChart"></canvas>
                    </div>
                    <div className="chart-container">
                        <h3 className="text-lg font-medium mb-2">Citations Over Time</h3>
                        <canvas id="historyChart"></canvas>
                    </div>
                    <div className="chart-container">
                        <h3 className="text-lg font-medium mb-2">Cited By Platforms</h3>
